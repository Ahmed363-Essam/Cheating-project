                                ...
                                <div class="card ">
                                    <div class="card-body">
                                        <div class="counter-status d-flex md-mb-0">
                                            ...
                                            <div class="ml-auto">
                                                <h5 class="tx-13">Nmeber Of Cheating Student</h5>
                                ...
                                <div class="card ">
                                    <div class="card-body">
                                        <div class="counter-status d-flex md-mb-0">
                                            ...
                                            <div class="ml-auto">
                                                <h5 class="tx-13">Nmeber Of Non Cheating Student</h5>
                            ...
                            <div class="card-body">
                                <div class="tabs-menu ">
                                    ...
                                    <ul class="nav nav-tabs profile navtab-custom panel-tabs">
                                        <li class="active">
                                            <a href="#home" data-toggle="tab" aria-expanded="true"> <span class="visible-xs"><i class="las la-user-circle tx-16 mr-1"></i></span> <span class="hidden-xs">Cheating List</span> </a>
                                        </li>
                                        <li class="">
                                            <a href="#profile" data-toggle="tab" aria-expanded="false"> <span class="visible-xs"><i class="las la-images tx-15 mr-1"></i></span> <span class="hidden-xs">Non Cheating List</span> </a>
                                        </li>
                                        <li class="">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table text-md-nowrap example1" id="example1">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($CheatingStudents as $CheatingStudent) {
                                                    ?>
                                                        <tr>
                                                            <td><?php echo $CheatingStudent['student_name'] ?></td>
                                                            <td> Cheating </td>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table text-md-nowrap example1" id="example1">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($NonSheatingStudents as $NonSheatingStudent) {
                                                        ?>
                                                            <tr>
                                                                <td><?php echo $NonSheatingStudent['student_name'] ?></td>
                                                                <td> Non Cheating </td>
