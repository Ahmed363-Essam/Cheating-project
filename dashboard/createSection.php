...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (isset($_POST["add"])) {
		...
		try {
			...
			$doctor_name = filter_var($_POST["doctor_name"]);
			$doctor_email = filter_var($_POST["doctor_email"]);
			$doctor_subject = filter_var($_POST["doctor_subject"]);
			$Inst_Name1 = filter_var($_POST["Inst_Name1"]);
			$Inst_Name2 = filter_var($_POST["Inst_Name2"]);
			$Inst_Name3 = filter_var($_POST["Inst_Name3"]);
			$section_name = filter_var($_POST["section_name"]);
			$exam_name = filter_var($_POST["exam_name"]);
			$exam_time = filter_var($_POST["exam_time"]);
			$exam_date = filter_var($_POST["exam_date"]);
			...
			$ins = $con->prepare("INSERT INTO `exam`(doctor_name,doctor_email,doctor_subject,Inst_Name1,Inst_Name2,Inst_Name3,section_name,exam_name,exam_time,exam_date) VALUE(:doctor_name,:doctor_email,:doctor_subject,:Inst_Name1,:Inst_Name2,:Inst_Name3,:section_name,:exam_name,:exam_time,:exam_date)");

			$ins->bindParam("doctor_name", $doctor_name);
			$ins->bindParam("doctor_email", $doctor_email);
			$ins->bindParam("doctor_subject", $doctor_subject);
			$ins->bindParam("Inst_Name1", $Inst_Name1);
			$ins->bindParam("Inst_Name2", $Inst_Name2);
			$ins->bindParam("Inst_Name3", $Inst_Name3);
			$ins->bindParam("section_name", $section_name);
			$ins->bindParam("exam_name", $exam_name);
			$ins->bindParam("exam_time", $exam_time);
			$ins->bindParam("exam_date", $exam_date);
							...
							<div class="card">
								<div class="card-body">
									...
									<div id="wizard2">
										...
										<section>
											<p class="mg-b-20">Enter The Doctor Information</p>
											<div class="row row-sm">
												<div class="col-md-5 col-lg-4">
													<label class="form-control-label">Doctor Name: <span class="tx-danger">*</span></label> <input class="form-control" id="doctor_name" name="doctor_name" placeholder="Enter Doctor Name" required="" type="text">
												</div>
												<div class="col-md-5 col-lg-4 mg-t-20 mg-md-t-0">
													<label class="form-control-label">Doctor Email: <span class="tx-danger">*</span></label> <input class="form-control" id="doctor_email" name="doctor_email" placeholder="Enter Doctor Email" required="" type="text">
												</div>
												<div class="col-md-5 col-lg-4 mg-t-20 mg-md-t-0">
													<label class="form-control-label">Doctor Subject: <span class="tx-danger">*</span></label> <input class="form-control" id="doctor_subject" name="doctor_subject" placeholder="Enter Doctor Subject" required="" type="text">
												</div>
											</div>
										</section>
										<h3>Instructor Information</h3>
										<section>
											<p>Enter Instructor Information.</p>
											<div class="row">
												<div class="col-md-5 col-lg-4">
													<label class="form-control-label">First Instructor Name: <span class="tx-danger">*</span></label> <input class="form-control" id="Inst_Name1" name="Inst_Name1" placeholder="Enter First Instructor  Name" required="" type="text">
												</div>
												<div class="col-md-5 col-lg-4 mg-t-20 mg-md-t-0">
													<label class="form-control-label">Second Instructor Name: <span class="tx-danger">*</span></label> <input class="form-control" id="Inst_Name2" name="Inst_Name2" placeholder="Enter Second Instructor Name" required="" type="text">
												</div>
												<div class="col-md-5 col-lg-4 mg-t-20 mg-md-t-0">
													<label class="form-control-label">Third Instructor Name: <span class="tx-danger">*</span></label> <input class="form-control" id="Inst_Name3" name="Inst_Name3" placeholder="Enter Third Instructor Name" required="" type="text">
												</div>
											</div>

										</section>
										<h3>Section && Exam Detail</h3>
										<section>
											<p>Section && Exam Detail.</p>

											<div class="row">
												<div class="col-md-5 col-lg-4">
													<label class="form-control-label">Section Name: <span class="tx-danger">*</span></label> <input class="form-control" id="section_name" name="section_name" placeholder="Enter Section  Name" required="" type="text">
												</div>
												<div class="col-md-5 col-lg-4 mg-t-20 mg-md-t-0">
													<label class="form-control-label">Exam Name: <span class="tx-danger">*</span></label> <input class="form-control" id="exam_name" name="exam_name" placeholder="Enter Exam Name" required="" type="text">
												</div>
												<div class="col-md-5 col-lg-4 mg-t-20 mg-md-t-0">
													<label class="form-control-label">Exam Time: <span class="tx-danger">*</span></label> <input class="form-control" id="exam_time" name="exam_time" placeholder="Enter Exam Time" required="" type="time">
												</div>
											...
											<div class="row">
												<div class="col-md-12 col-lg-12 mg-t-20 mg-md-t-0">
													<label class="form-control-label">Exam Date: <span class="tx-danger">*</span></label> <input class="form-control" id="exam_date" name="exam_date" placeholder="Enter Exam Time" required="" type="date">
												</div>
											...
											<br>
											<button class="btn ripple btn-primary br-tl-0 br-bl-0" name="add" type="submit">Submit</button>
