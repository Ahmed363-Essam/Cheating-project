    ...
    <div class="page">
        ...
        <div class="main-content app-content">
            ...
            <div class="container-fluid">
                ...
                <!-- row -->
                <!-- row -->
                <form action="attendenceFile.php" method="POST" enctype="multipart/form-data">
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="main-content-label mg-b-5">
                                        <div>
                                            <label class="form-control-label">Upload Attendence Sheet : </label>
                                            <br>
                                            <br>

                                            <input class="form-control" type="hidden" name="exam_id" value="<?= $_GET['id'] ?>">
                                            <input class="form-control" type="file" name="Attendence_file" id="formFile">
                                        </div>
                                    </div>
                                    <br>
                                    <button class="btn ripple btn-danger pd-x-25" type="submit" name="save_excel_data">Submit</button>
                ...
                <form action="cheating.php" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="main-content-label mg-b-5">
                                        <div>
                                            <label class="form-control-label">Upload Cheating Sheet : </label>
                                            <br>
                                            <br>
                                            <input class="form-control" type="hidden" name="exam_id" value="<?= $_GET['id'] ?>">

                                            <input class="form-control" type="file" name="Cheating_file">
                                        </div>
                                    </div>
                                    <br>
                                    <button class="btn ripple btn-danger pd-x-25" type="submit" name="save_excel_data_cheating">Submit</button>
