...
// Number Of Attendence  Student
$sel2 = $con->prepare("SELECT * FROM `attendence_report` WHERE `status`=1 AND exam_id=:exam_id");
$sel2->bindParam("exam_id", $_GET['id']);

$sel2->execute();

$AttendenceStudents = $sel2->fetchAll();

// Number Of Absence Student
$selAtd = $con->prepare("SELECT * FROM `attendence_report` WHERE `status`=0 AND exam_id=:exam_id");
$selAtd->bindParam("exam_id", $_GET['id']);

$selAtd->execute();

$AbsenceStudents = $selAtd->fetchAll();
                                ...
                                <div class="card ">
                                    <div class="card-body">
                                        <div class="counter-status d-flex md-mb-0">
                                            ...
                                            <div class="ml-auto">
                                                <h5 class="tx-13">Nmeber Of Attendence Student</h5>
                                                <h2 class="mb-0 tx-22 mb-1 mt-1"><?= $sel2->rowCount() ?></h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card ">
                                    <div class="card-body">
                                        <div class="counter-status d-flex md-mb-0">
                                            ...
                                            <div class="ml-auto">
                                                <h5 class="tx-13">Nmeber Of Absence Student</h5>
                                                <h2 class="mb-0 tx-22 mb-1 mt-1"><?= $selAtd->rowCount() ?></h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="tabs-menu ">
                                    ...
                                    <ul class="nav nav-tabs profile navtab-custom panel-tabs">
                                        <li class="active">
                                            <a href="#home" data-toggle="tab" aria-expanded="true"> <span class="visible-xs"><i class="las la-user-circle tx-16 mr-1"></i></span> <span class="hidden-xs">Attendence List</span> </a>
                                        </li>
                                        <li class="">
                                            <a href="#profile" data-toggle="tab" aria-expanded="false"> <span class="visible-xs"><i class="las la-images tx-15 mr-1"></i></span> <span class="hidden-xs">Absence  List</span> </a>
                                        </li>
                                        <li class="">
                                            <a href="#settings" data-toggle="tab" aria-expanded="false"> <span class="visible-xs"><i class="las la-cog tx-16 mr-1"></i></span> <span class="hidden-xs">Reporting</span> </a>
                                        </li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table text-md-nowrap example1" id="example1">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($AttendenceStudents as $AttendenceStudent) {
                                                    ?>
                                                        <tr>
                                                            <td><?php echo $AttendenceStudent['student_name'] ?></td>
                                                            <td> Attendence </td>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table text-md-nowrap example1" id="example1">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td><?php echo $AbsenceStudent['student_name'] ?></td>
                                                                <td> Absence </td>
